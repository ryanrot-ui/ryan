...
const t = [
  ...
  ['#navLinks li:nth-child(2) a', '施術', 'Treatments'],
  ...
  ['.hero-ctas a:nth-child(2)', '施術を見る', 'View Treatments'],
  ...
  ['#menu .section-header .section-tag', 'TREATMENT', 'TREATMENT'],
  ['#menu .section-header h2', '施術・料金', 'Treatments &amp; Pricing'],
  ['#menu .section-header p', 'お体の状態に合わせて、最適な施術をお選びください。', 'Choose the treatment that best suits your body\'s needs.'],
  ...
  ['.menu-cta p', '初めてのご来店の方も、お気軽にご相談ください。お体の状態に合わせて最適な施術をご提案いたします。', 'First time visitors are always welcome. Our staff will help you find the perfect treatment for your body.'],
  ...
  ['#tab-foot .menu-item:nth-child(1) .menu-item-info > p', '足裏の主要反射区を重点的にほぐします。ちょっとした疲れ取りに最適な短時間施術。', 'Focused work on the key reflex zones of the sole. The ideal short treatment for a quick refresh.'],
  ['#tab-foot .menu-item:nth-child(1) .tag', 'お試し', 'Try It'],
  ['#tab-foot .menu-item:nth-child(2) h4', 'フットマッサージ 60分', 'Foot Massage 60 min'],
  ['#tab-foot .menu-item:nth-child(2) .menu-item-info > p', '足裏全体・ふくらはぎ・すねまで丁寧にほぐします。1日の疲れをしっかりとケアする人気の施術。', 'Full sole, calf, and shin treatment. Our most popular treatment for unwinding after a long day.'],
  ...
  ['#tab-body .menu-item:nth-child(1) .menu-item-info > p', '背中・肩を中心にほぐす短時間施術。肩こりや背中の張りに効果的です。', 'A focused short treatment targeting the back and shoulders. Effective for shoulder stiffness and upper-back tension.'],
  ...
  ['#tab-body .menu-item:nth-child(2) .menu-item-info > p', '上半身全体をしっかりとケア。背中・肩・首・腕まで丁寧にほぐします。定番人気の施術。', 'Full upper-body care covering the back, shoulders, neck, and arms. Our classic, popular treatment.'],
  ...
  // Combo tab
  ['#tab-combo .menu-note', '<strong>フット+ボディのセット施術</strong>足裏から全身まで、組み合わせることでより深いリラクゼーション効果が得られます。個別に頼むよりもお得なコンビネーション価格です。', '<strong>Foot + Body Set Treatments</strong> Combining both treatments delivers a deeper relaxation effect from sole to spine. Priced better than booking each separately.'],
  ...
  ['#tab-combo .menu-item:nth-child(1) .tag', 'お得', 'Great Value'],
  ...
  ['#tab-combo .menu-item:nth-child(3) .tag', '贅沢施術', 'Luxury Treatment'],
  // Options tab
  ['#tab-options .menu-note', '<strong>いずれの施術にも追加可能です。</strong>施術前またはご予約時にお伝えください。スタッフにご相談いただければ最適な組み合わせをご提案します。', '<strong>Add-ons available with any treatment.</strong> Let us know before your session or at the time of booking. Our staff will suggest the best combination.'],
  ...
  ['#rv1-text', '「仕事帰りに立ち寄りました。深夜でも清潔感があって、スタッフの方がとても親切です。フット60分施術を受けましたが、足の疲れがすっきりと取れました。価格も納得できます。また必ず来ます。」', '"Stopped in on the way home from work. Even at midnight, everything was spotless and the staff were genuinely kind. Took the 60-min foot treatment and my feet felt brand new after. Great value too — I\'ll definitely be back."'],
  ...
  ['#rv3-text', '「初めての利用でしたが、スタッフの方が丁寧に施術内容を説明してくださいました。コンビネーション90分施術を試したところ、終わった後の体の軽さが全然違います。大久保駅から近くて便利です。おすすめ！」', '"My first visit, and the staff walked me through everything patiently. Tried the 90-min combination treatment and the difference in how my body felt afterwards was remarkable. Very convenient — just a short walk from Okubo Station. Highly recommended!"'],
  ...
  ['label[for="guests"]', 'ご希望の施術', 'Preferred Treatment'],
  ...
  ['.footer-grid > :nth-child(2) ul li:nth-child(2) a', '施術', 'Treatments'],
